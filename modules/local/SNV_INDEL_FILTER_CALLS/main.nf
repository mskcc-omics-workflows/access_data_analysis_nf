...
//    publishDir "${params.outdir}/intermediate/small_variants/${patient_id}", mode: 'copy', pattern: '*snv_indel.allele_counts.csv'
...
//    publishDir "${params.outdir}/intermediate/small_variants/${patient_id}", mode: 'copy', pattern: "*hotspot_ch.csv"
    output:
...
process SNV_INDEL_ADD_FILTER_COL {
    ...
    publishDir "${params.outdir}/intermediate/${patient_id}", mode: 'copy', pattern: "*filter.csv"
...
process SNV_INDEL_ADD_FACETS_ADJUSTED_VAF {
    ...
    publishDir "${params.outdir}/intermediate/${patient_id}", mode: 'copy', pattern: '*adj_vaf_all_impact.csv'
